...
2) Markdown contents file by file in a folder under /db/ (folder name is the project name, file name is page name, first page must be named "index" - in both folder and file names no spaces, no special characters)
